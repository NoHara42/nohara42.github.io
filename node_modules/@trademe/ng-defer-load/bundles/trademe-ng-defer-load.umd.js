(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@trademe/ng-defer-load', ['@angular/core','@angular/common','exports', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,(global.trademe = global.trademe || {}, global.trademe['ng-defer-load'] = {}), global.ng.common, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var DeferLoadDirective = /** @class */ (function () {
        function DeferLoadDirective(_element, _zone, platformId) {
            ...
            this.deferLoad = new core.EventEmitter();
        ...
        DeferLoadDirective.prototype.ngOnInit = function () {
            if ((common.isPlatformServer(this.platformId) && this.preRender === true) ||
                (common.isPlatformBrowser(this.platformId) && this.fallbackEnabled === false && !this.hasCompatibleBrowser())) {
                this.load();
            }
        };
        ...
        DeferLoadDirective = __decorate([ __param(2, core.Inject(core.PLATFORM_ID))
        ], DeferLoadDirective);
DeferLoadDirective.ɵfac = function DeferLoadDirective_Factory(t) { return new (t || DeferLoadDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID)); };
...
DeferLoadModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DeferLoadModule_Factory(t) { return new (t || DeferLoadModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DeferLoadModule, { declarations: [DeferLoadDirective], imports: [ɵngcc1.CommonModule], exports: [DeferLoadDirective] }); })();
...
//# sourceMappingURL=trademe-ng-defer-load.umd.js.map